  ...
  xhttp.onreadystatechange = function() {
    ...
    if (this.readyState == 4 
      ...
      chartData.options.title.text 
        = "Covid 19 Hotspots" + " " + dayjs().format();
...
for (let i=0; i< covidJsObj.Countries.length; i++) {
  newArray.push({
    ...
    "TotalDeaths":
covidJsObj.Countries[i].TotalDeaths,
    "Population": population[i],
    "TotalConfirmedPer100000":
                ((covidJsObj.Countries[i].TotalConfirmed/populations[i]) * 100000)
  })
...
for (let i=0; i<covidJsObj.Countries.length; i++) {
  newArray.push({
    ...
    "TotalDeaths":
covidJsObj.Countries[i].TotalDeaths,
    "Population": covidJsObj.Countries[i].population[i],
    "TotalConfirmedPer100000":
                ((covidJsObj.Countries[i].TotalConfirmed/populations[i]) * 100000)
  }) 
*/
